...
class PyTimeCode(object):
    def __init__(self, framerate, start_timecode=None, frames=None, drop_frame=False, iter_return="tc"):
        ...
        """
        if drop_frame and (framerate != '59.94' or framerate != '29.97'):
        ...
        if start_timecode:
            ...
            self.tc_to_frames()
        elif not frames is None:  # because 0==False, and frames can be 0
    ...
    def frames_to_tc(self, frame_only=False):
        ...
        if self.drop_frame:
            if self.frs == 0 and (
                    self.mins % 10):  # tests to see if frames is 0 and if minutes is not an even 10, 20, 30, etc
...
if __name__ == "__main__":
    ...
    tc = "00:00:00:040"
    fps = 25
    ptc = PyTimeCode(framerate=fps, start_timecode=tc, drop_frame=False)
    # print(ptc.frames) #90000
    ptcB = PyTimeCode(framerate=fps, frames=90000, drop_frame=False, iter_return="tc")
    print(ptc)  # 01:00:00:00
